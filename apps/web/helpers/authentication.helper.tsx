...
const errorCodeMessages: {
  ...
  [EAuthenticationErrorCodes.MAGIC_LINK_LOGIN_DISABLED]: {
    get title() {
      return i18nInstance.t("auth_errors.magic_link_login_disabled");
    },
    message: () => i18nInstance.t("auth_errors.magic_link_login_disabled_please_contact_your_administrator"),
  },
  [EAuthenticationErrorCodes.PASSWORD_LOGIN_DISABLED]: {
    get title() {
      return i18nInstance.t("auth_errors.password_login_disabled");
    },
    message: () => i18nInstance.t("auth_errors.password_login_disabled_please_contact_your_administrator"),
  },
  ...
  [EAuthenticationErrorCodes.PASSWORD_TOO_WEAK]: {
    get title() {
      return i18nInstance.t("auth_errors.password_too_weak");
    },
    message: () => i18nInstance.t("auth_errors.please_use_a_stronger_password"),
  },
  ...
  [EAuthenticationErrorCodes.USER_ALREADY_EXIST]: {
    ...
    message: (email = undefined) => (
      <div>
        ...
        >
          {i18nInstance.t("auth_errors.sign_in")}
        </Link>
  ...
  [EAuthenticationErrorCodes.USER_DOES_NOT_EXIST]: {
    ...
    message: (email = undefined) => (
      <div>
        ...
        >
          {i18nInstance.t("auth_errors.create_one")}
        </Link>
  ...
  [EAuthenticationErrorCodes.INVALID_PASSWORD_TOKEN]: {
    ...
    message: () => i18nInstance.t("auth_errors.invalid_password_token_2"),
  },
  ...
  [EAuthenticationErrorCodes.ADMIN_USER_DEACTIVATED]: {
    get title() {
      return i18nInstance.t("auth_errors.admin_user_deactivated");
    },
    message: () => <div>Your account is deactivated</div>,
  },
  [EAuthenticationErrorCodes.RATE_LIMIT_EXCEEDED]: {
    title: "",
    message: () => i18nInstance.t("auth_errors.rate_limit_exceeded_please_try_again_later"),
  },
};
