...
export const IssueAssigneeActivity = observer(function IssueAssigneeActivity(props: TIssueAssigneeActivity) {
  ...
  return (
    ...
    >
      <>
        {activity.old_value === "" ? t("issue_activity.assignee.added") : t("issue_activity.assignee.removed")}
        <a
        ...
        {showIssue && (activity.old_value === "" ? t("issue_activity.assignee.to") : t("issue_activity.assignee.from"))}
