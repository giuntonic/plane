...
export const IssueEstimateActivity = observer(function IssueEstimateActivity(props: TIssueEstimateActivity) {
  ...
  return (
    ...
    >
      <>
        {activity.new_value ? t("issue_activity.estimate.set") : t("issue_activity.estimate.removed")}
        {activity.new_value ? activity.new_value : activity?.old_value}
        {showIssue && (activity.new_value ? t("issue_activity.estimate.to") : t("issue_activity.estimate.from"))}
