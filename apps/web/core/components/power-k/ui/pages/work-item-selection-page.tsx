      ...
      {/* {searchTerm === "" ? (
        recentIssues.length > 0 ? (
          <CommandPaletteEntityList
            ...
            emptyText={t("ui.search_for_issue_id_or_issue_title")}
          />
        ) : (
          <div className="px-3 py-8 text-center text-13 text-tertiary">{t("ui.search_for_issue_id_or_issue_title")}</div>
        )
