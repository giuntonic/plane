...
export const GeneralProfileSettingsForm = observer(function GeneralProfileSettingsForm(props: Props) {
    ...
    await updateCurrentUser({
      ...
      .then(() => {
        setToast({
          ...
          message: t("ui.profile_picture_deleted_successfully"),
        });
        setValue("avatar_url", "");
        return;
      })
      .catch(() => {
        setToast({
          ...
          title: t("toast.error"),
          message: t("ui.there_was_some_error_in_deleting_your"),
        });
      })
      .finally(() => {
  ...
  const onSubmit = async (formData: TUserProfileForm) => {
    ...
    setPromiseToast(updatePromise, {
      ...
      error: {
        title: t("toast.error"),
        message: () => t("ui.profile_update_failed"),
      },
    });
  };
