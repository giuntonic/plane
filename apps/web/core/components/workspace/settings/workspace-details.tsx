  ...
  const onSubmit = async (formData: IWorkspace) => {
    ...
    try {
      ...
      setToast({
        ...
        message: t("workspace_settings.settings.general.toasts.updated"),
      });
    } catch (err: unknown) {
      console.error(err);
    } finally {
  ...
  const handleRemoveLogo = async () => {
    ...
    try {
      ...
      setToast({
        type: TOAST_TYPE.SUCCESS,
        title: t("toast.success"),
        message: t("workspace_settings.settings.general.toasts.logo_removed"),
      });
    } catch {
      setToast({
        type: TOAST_TYPE.ERROR,
        title: t("toast.error"),
        message: t("workspace_settings.settings.general.toasts.logo_remove_error"),
      });
    }
  };
  ...
  const handleCopyUrl = () => {
    ...
    void copyUrlToClipboard(`${currentWorkspace.slug}`)
      .then(() => {
        setToast({
          type: TOAST_TYPE.SUCCESS,
          title: t("workspace_settings.settings.general.toasts.url_copied"),
        });
        return undefined;
      })
      .catch(() => {
