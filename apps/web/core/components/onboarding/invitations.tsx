  ...
  return invitations && invitations.length > 0 ? (
    <div className="space-y-4">
      <div className="mx-auto space-y-1 py-4 text-center">
        <h3 className="text-24 font-bold text-primary">{t("workspace_invitations_step.title")}</h3>
        <p className="font-medium text-placeholder">{t("workspace_invitations_step.subtitle")}</p>
      </div>
      <div>
        {invitations &&
      ...
      >
        {isJoiningWorkspaces ? <Spinner height="20px" width="20px" /> : t("workspace_invitations_step.continue_to_workspace")}
      </Button>
      <div className="mx-auto mt-4 flex items-center sm:w-96">
        <hr className="w-full border-strong" />
        <p className="mx-3 flex-shrink-0 text-center text-13 text-placeholder">{t("workspace_invitations_step.or")}</p>
        <hr className="w-full border-strong" />
      </div>
      <Button
        variant="ghost"
      ...
      >
        {t("workspace_invitations_step.create_own_workspace")}
      </Button>
    </div>
  ) : (
    <div>{t("workspace_invitations_step.no_invitations_found")}</div>
  );
}
