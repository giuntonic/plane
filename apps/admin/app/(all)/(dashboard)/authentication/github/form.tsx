...
export function InstanceGithubConfigForm(props: Props) {
  ...
  const GITHUB_FORM_FIELDS: TControllerInputFormField<GithubConfigFormValues>[] = [
    ...
    },
    {
      ...
      type: "text",
      label: t("ui.organization_id"),
      description: <>{t("ui.the_organization_github_id")}</>,
  ...
  const onSubmit = async (formData: GithubConfigFormValues) => {
    ...
    try {
      ...
      setToast({
        ...
        title: t("ui.done"),
        message: t("ui.your_github_authentication_is_configured_you_should"),
      });
      reset({
      ...
      <div className="flex flex-col gap-8">
        <div className="grid w-full grid-cols-2 gap-x-12 gap-y-8">
          <div className="col-span-2 flex flex-col gap-y-4 pt-1 md:col-span-1">
            <div className="pt-2.5 text-18 font-medium">{t("ui.github_provided_details_for_plane")}</div>
          ...
          <div className="col-span-2 flex flex-col gap-y-6 md:col-span-1">
            <div className="pt-2 text-18 font-medium">{t("ui.plane_provided_details_for_github")}</div>
