...
urlpatterns = [
    ...
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/metabase-embed/",
        ProjectMetabaseEmbedEndpoint.as_view(),
        name="project-metabase-embed",
    ),
]
